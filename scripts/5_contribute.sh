...
# contribute
cleos transfer $CONTRIBUTOR createbridge "$AMOUNT" "$DAPP,$TOTAL_RAM,$TOTAL_ACCOUNTS" -p $CONTRIBUTOR
cleos transfer $CUSTODIAN_ACCOUNT createbridge "$AMOUNT" "$DAPP,$TOTAL_RAM,$TOTAL_ACCOUNTS" -p $CUSTODIAN_ACCOUNT
